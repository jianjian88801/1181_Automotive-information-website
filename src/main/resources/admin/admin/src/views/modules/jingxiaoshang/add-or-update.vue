    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="门店介绍" prop="mendianjieshao">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.mendianjieshao" label="门店介绍" prop="mendianjieshao">
                    <span v-html="ruleForm.mendianjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.mendianjieshao = this.ruleForm.mendianjieshao.replace(reg,'../../../springbootjtw43/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
